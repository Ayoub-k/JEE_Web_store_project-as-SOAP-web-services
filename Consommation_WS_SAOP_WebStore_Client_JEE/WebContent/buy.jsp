...
<body>
	...
	<div class="shapebook1" style="margin-left: 400px;">
		<div>
			<p style="text-align: center; color: royalblue;">Create New
				Account</p>
			<form action="servletclient" method="get">
				...
				<input type="text" name="nombre" placeholder="Phone"
					pattern="[0-9]{10}"><br> <input type="text"
					name="email" placeholder="Email"><br> <input
		...
		<div style="margin-left: 150px;">
			<p style="text-align: center; color: royalblue;">Log In</p>
	...
	<footer>
		<div class="foter">
			...
			<p style="color: white;">
				Contact information: <a href="ELKADDOURI@outlook.fr"
					style="color: aqua">ELKADDOURI@outlook.fr</a>
			</p>
		</div>
	</footer>
</body>
